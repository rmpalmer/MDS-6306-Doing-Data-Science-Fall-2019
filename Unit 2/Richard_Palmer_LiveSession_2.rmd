...
# levels(education$Educ) <- c("<12","12","13-15","16",">16")
#levels(education$Educ) <- factor(education$Educ,levels=c(1,5,2,3,4))
#levels(education$Educ) <- ordered(education$Educ,levels=c("<12","12","13-15","16",">16"))
