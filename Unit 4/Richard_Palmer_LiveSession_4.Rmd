...
#rest1 <-   getURL("https://d396qusza40orc.cloudfront.net/getdata%2Fdata%wFrestaurants.xml")
#doc <- xmlParse(rest1)
...
```{r}
sushi_indices <- grep("sushi",all_restaurants$hp_name,ignore.case=TRUE) 
total_sushi <- length(sushi_indices)
```
