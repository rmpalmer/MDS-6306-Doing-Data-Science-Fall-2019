...
CM = confusionMatrix(table(predict(model_b,testTitanic[,pred_indices]),as.factor(testTitanic$Survived)))
CM
```
...
for (j in 1:iterations)
{
  ...
  CM_c <- confusionMatrix(table(predict(model_c,testTitanic[,pred_indices]),as.factor(testTitanic$Survived)))
...
for (j in 1:iterations)
{
  ...
  CM_d <- confusionMatrix(table(predict(model_d,testTitanic[,pred_indices]),as.factor(testTitanic$Survived)))
